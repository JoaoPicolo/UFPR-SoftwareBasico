...
alocaMem:
    ...
    call worstFit                     # Valor do bloco ja esta em %rdi, por isso so chama funcao
    cmpq $-1, %rax
...
worstFit:
    ...
    verificaMelhor:
    cmpq 8(%r10), %r15               # Se tamanho for menor ou igual ao melhor do momento, vai pro proximo
    jle proximoBlocoBest
    movq %r12, %r10
